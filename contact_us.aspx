<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact_us.aspx.cs" Inherits="project2114.about" %>
        ...
        <div class="auto-style8">
            ...
            <table class="auto-style2">
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:TextBox ID="TextBox2" runat="server" BackColor="Transparent" Height="44px" Width="370px" ForeColor="White" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:Button ID="Button6" runat="server" CssClass="auto-style7" Height="47px" OnClick="Button6_Click" Text="Submit" Width="161px" />
                    </td>
                </tr>
            </table>
