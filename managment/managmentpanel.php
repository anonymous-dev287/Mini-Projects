...
<head>
	<meta charset="UTF-8">
	<title>Managment Panel MCU Collage</title>
...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="header">
		<div class="coverhead">
			<a href="../pages/index.html" id="logo"><img src="../images/th.png" alt="th" height="58" width="381"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
						...
						<li><a href="thut.php"><i class="fa fa-sign-out fa-fw fa-lg " aria-hidden="true"></i>Sign Out</a></li>
     				   </ul> 
...
<div class="footer">
	...
	<div class="foot4">
		<div class="f41">
			...
			<a href="thut.php"><i class="fa fa-sign-out fa-lg "></i></a>
		</div>
		<div class="f42">
			<br>
