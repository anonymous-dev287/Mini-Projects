...
//$matchEditFound=(array_key_exists("edit", $_GET));
//$matchEditFromFound=(array_key_exists("edited_form", $_GET));


//echo("<script>console.log('matchEditFound:".$matchEditFound."')</script>");
//echo("<script>console.log('matchEditFromFound:".$matchEditFromFound."')</script>");

$edit_record ='';

// $matchEditFound==1 || $matchEditFound==true ? $_GET['edit']: $matchEditFromFound?$_GET['edited_form']:'';
if(isset($_GET["edit"])){

	$edit_record=$_GET["edit"];
}elseif (isset($_GET["edited_form"])) {
	$edit_record=$_GET["edited_form"];
}
...
$sid=""; $student_name="";$father_name="";

echo("<script>console.log('Sid:".$result->num_rows."')</script>");
...
//	echo("<script>"$student_name);
	echo("<script>console.log('Sid:".$sid."')</script>");
...
<head>
	<meta charset="UTF-8">
	<title>B.Com Class MCU Collage</title>
...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="header">
		<div class="coverhead">
			<a href="index.html" id="logo"><img src="../images/th.png" alt="logo" height="58" width="381"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
...
<div class="footer">
	...
	<div class="foot4">
		...
		<div class="f42">
			<br>
			<i class="fa fa-envelope fa-fw"></i>tony3000@gmail.com<br><br>
