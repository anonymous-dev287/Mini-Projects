...
namespace project2114
{
    public partial class placeorder : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                TextBox1.Text = Session["addr"].ToString();
                TextBox2.Text = Session["mob"].ToString();
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        da.Fill(ds);
                        dr["sno"] = 1;
                        dr["Product_id"] = ds.Tables[0].Rows[0]["productid"].ToString();
                        dr["Product_name"] = ds.Tables[0].Rows[0]["productname"].ToString();
                        dr["Product_image"] = ds.Tables[0].Rows[0]["productimage"].ToString();
        ...
        {
            String updatepass = "insert into orderaddress(orderid,address,mob) values('" + Label6.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "')";
            String mycon1 = "Data Source=LAPTOP-EPAOJUO7\\SQLEXPRESS;Initial Catalog=project_2114;Integrated Security=True";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                String updatepass = "insert into orderdetails(orderid,sno,Product_id,Product_name,Price,quantity,dateoforder) values('" + Label6.Text + "'," + dt.Rows[i]["sno"] + "," + dt.Rows[i]["Product_id"] + ",'" + dt.Rows[i]["Product_name"] + "'," + dt.Rows[i]["price"] + "," + dt.Rows[i]["quantity"] + ",'" + Label7.Text + "')";
                String mycon1 = "Data Source=LAPTOP-EPAOJUO7\\SQLEXPRESS;Initial Catalog=project_2114;Integrated Security=True";
                SqlConnection s = new SqlConnection(mycon1);
                s.Open();
                SqlCommand cmd1 = new SqlCommand();
            ...
            saveaddress();
            Response.Redirect("Success.aspx?orderid="+Label6.Text);
