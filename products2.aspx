<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products2.aspx.cs" Inherits="project2114.products2" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>            
             <ul class="main-nav">    
                ...
                <li><asp:Button ID="Button3" runat="server" CssClass="btn" Text="SHOW CART"  CausesValidation="False" OnClick="Button3_Click"/></li>
        ...
        <div>
            ...
            <asp:DataList ID="DataList1" CssClass="datalist" runat="server" DataKeyField="Product_id" DataSourceID="SqlDataSource1" RepeatColumns="3" OnItemCommand="DataList1_ItemCommand" BorderColor="White" BorderWidth="2px" GridLines="Both" Height="16px" RepeatDirection="Horizontal" Width="16px" CellPadding="0">
                <ItemTemplate>
                    <table class="auto-style1">
                        ...
                        <tr>
                            <td class="auto-style10" colspan="2">
                                <asp:Button ID="Button1" runat="server" CommandArgument='<%# Eval("Product_id")%>' CommandName="addtocart" CssClass="auto-style3" Height="51px" Text="Add to Cart" Width="277px" />
                            </td>
                        </tr>
                    </table>
                    <br />
