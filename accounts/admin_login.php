...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="header">
		<div class="coverhead">
			<a href="../index.html" id="th"><img src="../images/th.png" alt="th" height="65" width="300"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
  				 	<li><a href="#">MCU<sup><i class="fa fa-trademark fa-fw "></i></sup></a></li>
