...
<head>
	...
	<title> Home Page MCU College</title>
...
<body>
	<div class="header">
		<div class="coverhead">
			<a href="../pages/index.html" id="logo"><img src="../images/th.png" alt="logo" height="58" width="400"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
		...
		<div class="marginl">
				...
				<div class="greenbg">
					...
					<div class="detailbox">
							...
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical Care Facility 
					...
					<div class="detailbox" style="border-radius:0;">
							...
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical Care Facility 
							MCU College Provides the Medical <a href="library.html">Read More...</a> 
