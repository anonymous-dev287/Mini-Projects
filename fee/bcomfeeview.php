...
<head>
	<meta charset="UTF-8">
	<title>B.Com Fee Managment MCU Collage</title>
...
.detaillist ul li button{ padding:0;margin: 8px 0;border:none;background: white; }
...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="header">
		<div class="coverhead">
			<a href="../pages/index.html" id="logo"><img src="../images/th.png" alt="logo" height="58" width="381"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
...
if ($result->num_rows > 0) {
 ...
 // echo ("<script>console.log('".$row["monthlyfee"]."')</script>");
         echo " <div class='detaillist'>

								<ul >
									<li>". $row["roll_no"] ."</li>
									<li>". $row["student_name"] ."</li>
									<li>". ($row["monthlyfee"]=='' || $row["monthlyfee"]=="" ?"0.00":number_format((float)$row["monthlyfee"], 2, '.', ''))  ."</li>
									<li>	$k   </li>
									<li>". $remaining  ."</li>
